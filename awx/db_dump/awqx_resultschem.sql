...
CREATE TABLE `resultschem` (
  ...
  KEY `DetectionQuantitationLimitMeasureValue` (`DetectionQuantitationLimitMeasureValue`),
  CONSTRAINT `resultschem_ibfk_1` FOREIGN KEY (`CharacteristicName`) REFERENCES `characteristic` (`Name`),
  CONSTRAINT `resultschem_ibfk_10` FOREIGN KEY (`DetectionQuantitationLimitMeasureValue`) REFERENCES `measurementunit` (`Code`),
  ...
  CONSTRAINT `resultschem_ibfk_6` FOREIGN KEY (`ResultDetectionConditionText`) REFERENCES `resultdetectioncondition` (`Name`),
  CONSTRAINT `resultschem_ibfk_7` FOREIGN KEY (`ResultSampleFractionText`) REFERENCES `samplefraction` (`Name`),
  CONSTRAINT `resultschem_ibfk_8` FOREIGN KEY (`ResultAnalyticalMethodContext`) REFERENCES `analyticalmethodcontext` (`Code`),
  CONSTRAINT `resultschem_ibfk_9` FOREIGN KEY (`DetectionQuantitationTypeName`) REFERENCES `quantitationlimittype` (`Name`)
...
-- Dump completed on 2020-12-29 18:48:09
