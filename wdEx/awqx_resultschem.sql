...
CREATE TABLE `resultschem` (
  ...
  CONSTRAINT `resultschem_ibfk_2` FOREIGN KEY (`ResultValueTypeName`) REFERENCES `resultvaluetype` (`Name`),
  CONSTRAINT `resultschem_ibfk_3` FOREIGN KEY (`ResultStatusIdentifier`) REFERENCES `resultstatus` (`Name`),
  CONSTRAINT `resultschem_ibfk_4` FOREIGN KEY (`MethodSpeciationName`) REFERENCES `methodspeciation` (`Name`),
  CONSTRAINT `resultschem_ibfk_5` FOREIGN KEY (`ResultDetectionConditionText`) REFERENCES `resultdetectioncondition` (`Name`),
...
-- Dump completed on 2020-11-11  9:29:40
